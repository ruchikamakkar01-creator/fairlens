...
function App() {
  ...
  const insightsSourceLabel =
    insightsSource === "gemini"
      ? "Google Gemini"
      : insightsSource === "demo"
        ? "Demo narrative"
        : "Local fallback engine";
  const usingGemini = insightsSource === "gemini";
        ...
        >
          <div className="hero-copy">
            ...
            <p className="hero-text">
              Analyze datasets and models for hidden bias.
            </p>
            ...
            <div className="panel controls-panel">
              <div className="field-group">
                ...
                <p className="field-help">
                  FairLens automatically selects the best binary outcome
                  column (for example approved/rejected or {"<="}50K/{">"}50K).
                </p>
                <select
                  id="target-select"
                  value={targetColumn}
          ...
          <div className="dashboard-grid">
            ...
            <article className="panel insights-panel">
              ...
              <div className="insights-meta">
                <span className={`pill-soft${usingGemini ? " google-pill" : ""}`}>
                  {insightsSourceLabel}
                </span>
                {!usingGemini ? (
                  <p className="muted">
                    Add a valid `GEMINI_API_KEY` and restart the backend to turn on live Google
                    Gemini insights automatically.
                  </p>
                ) : (
                  <p className="muted">
                    Gemini is currently generating the narrative summary for this report.
                  </p>
                )}
              </div>
              <ul>
